...
### fluid主题的Tag插件
[Fluid文档地址](https://hexo.fluid-dev.com/docs/guide/#%E8%84%9A%E6%B3%A8) 

<a class="btn" href="https://hexo.fluid-dev.com/docs/guide/#%E8%84%9A%E6%B3%A8" title="title">Fluid文档地址</a>
...
**HTML形式:**
```
<p class="note note-primary">HTML形式标签</p>
```
<p class="note note-primary">HTML形式标签</p>
...
**行内便签:**
```
<span class="label label-primary">我是行内便签</span>
```
<span class="label label-primary">我是行内便签</span>
或
```
{% label danger @行内便签text %}
```
{% label danger @行内便签text %}
