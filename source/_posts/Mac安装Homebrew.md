...
> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [www.cnblogs.com](https://www.cnblogs.com/haojile/p/13193805.html)
...
以上方法来自：[https://zhuanlan.zhihu.com/p/111014448](https://zhuanlan.zhihu.com/p/111014448)
...
浏览器访问 https://raw.githubusercontent.com/Homebrew/install/master/install.sh 也访问不了，需要翻墙，暂时不具备翻墙条件，只能换个方式。

官方安装方法 2（未测试）
-------------

> 参考：[https://docs.brew.sh/Installation](https://docs.brew.sh/Installation)

```
# 安装在/usr/local/目录
cd /usr/local/
# 官方命令行，安装在 homebrew 目录
sudo mkdir homebrew && curl -L https://github.com/Homebrew/brew/tarball/master | tar xz --strip 1 -C homebrew
```


[HomeBrew自动安装脚本源码](https://gitee.com/cunkai/HomebrewCN/raw/master/Homebrew.sh)
```
#HomeBrew自动安装脚本
